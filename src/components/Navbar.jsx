    ...
    <>
      <nav className="bg-[#faf8ff]/90 dark:bg-slate-950/90 backdrop-blur-xl w-full top-0 sticky z-50 border-b border-slate-200/50 dark:border-slate-800/50 transition-colors duration-200 ease-in-out hidden md:block">
        <div className="flex justify-between items-center max-w-7xl mx-auto px-8 py-4">
          ...
          <div className="hidden md:flex items-center gap-10 font-headline font-medium text-sm">
            <Link className={`pb-1 transition-colors ${currentPath === '/' ? 'text-cyan-700 dark:text-cyan-400 border-b-2 border-cyan-700' : 'text-slate-600 dark:text-slate-400 hover:text-cyan-600 dark:hover:text-cyan-300'}`} to="/">Beranda</Link>
            <Link className={`pb-1 transition-colors ${currentPath === '/services' ? 'text-cyan-700 dark:text-cyan-400 border-b-2 border-cyan-700' : 'text-slate-600 dark:text-slate-400 hover:text-cyan-600 dark:hover:text-cyan-300'}`} to="/services">Layanan</Link>
            <Link className={`pb-1 transition-colors ${currentPath === '/portfolio' ? 'text-cyan-700 dark:text-cyan-400 border-b-2 border-cyan-700' : 'text-slate-600 dark:text-slate-400 hover:text-cyan-600 dark:hover:text-cyan-300'}`} to="/portfolio">Portofolio</Link>
            <Link className={`pb-1 transition-colors ${currentPath === '/consultation' ? 'text-cyan-700 dark:text-cyan-400 border-b-2 border-cyan-700' : 'text-slate-600 dark:text-slate-400 hover:text-cyan-600 dark:hover:text-cyan-300'}`} to="/consultation">Konsultasi</Link>
            <Link className={`pb-1 transition-colors ${currentPath === '/feedback' ? 'text-cyan-700 dark:text-cyan-400 border-b-2 border-cyan-700' : 'text-slate-600 dark:text-slate-400 hover:text-cyan-600 dark:hover:text-cyan-300'}`} to="/feedback">Ulasan</Link>
          </div>
      ...
      <nav className="md:hidden fixed bottom-0 left-0 right-0 bg-white/95 dark:bg-slate-900/95 backdrop-blur-xl border-t border-slate-200/80 dark:border-slate-800/80 h-16 flex items-center justify-around px-2 z-50 shadow-[0_-4px_20px_-10px_rgba(0,0,0,0.1)]">
        <Link to="/" className={`flex flex-col items-center gap-1 ${currentPath === '/' ? 'text-cyan-700 dark:text-cyan-400' : 'text-slate-500 dark:text-slate-400'}`}>
          <div className={`${currentPath === '/' ? 'bg-cyan-100 dark:bg-cyan-900/50' : ''} px-3 py-0.5 rounded-full flex items-center justify-center transition-all`}>
        ...
        <Link to="/services" className={`flex flex-col items-center gap-1 ${currentPath === '/services' ? 'text-cyan-700 dark:text-cyan-400' : 'text-slate-500 dark:text-slate-400 active:text-cyan-700 hover:text-cyan-600'}`}>
          <div className={`${currentPath === '/services' ? 'bg-cyan-100 dark:bg-cyan-900/50' : ''} px-3 py-0.5 rounded-full flex items-center justify-center transition-all`}>
        ...
        <Link to="/portfolio" className={`flex flex-col items-center gap-1 ${currentPath === '/portfolio' ? 'text-cyan-700 dark:text-cyan-400' : 'text-slate-500 dark:text-slate-400 active:text-cyan-700 hover:text-cyan-600'}`}>
          <div className={`${currentPath === '/portfolio' ? 'bg-cyan-100 dark:bg-cyan-900/50' : ''} px-3 py-0.5 rounded-full flex items-center justify-center transition-all`}>
          ...
          <span className="text-[10px] font-bold">Portofolio</span>
        </Link>
        <Link to="/consultation" className={`flex flex-col items-center gap-1 ${currentPath === '/consultation' ? 'text-cyan-700 dark:text-cyan-400' : 'text-slate-500 dark:text-slate-400 active:text-cyan-700 hover:text-cyan-600'}`}>
          <div className={`${currentPath === '/consultation' ? 'bg-cyan-100 dark:bg-cyan-900/50' : ''} px-3 py-0.5 rounded-full flex items-center justify-center transition-all`}>
        ...
        <Link to="/feedback" className={`flex flex-col items-center gap-1 ${currentPath === '/feedback' ? 'text-cyan-700 dark:text-cyan-400' : 'text-slate-500 dark:text-slate-400 active:text-cyan-700 hover:text-cyan-600'}`}>
          <div className={`${currentPath === '/feedback' ? 'bg-cyan-100 dark:bg-cyan-900/50' : ''} px-3 py-0.5 rounded-full flex items-center justify-center transition-all`}>
            <span className="material-symbols-outlined" style={{ fontVariationSettings: currentPath === '/feedback' ? "'FILL' 1" : undefined }}>reviews</span>
          </div>
